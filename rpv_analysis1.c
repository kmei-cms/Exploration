#define rpv_analysis1_cxx
#include "rpv_analysis1.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void rpv_analysis1::Loop( int max_events, bool verb )
{
    ...
    //+++++++++ Above here is gen-level only.  Below adds reco jets.  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      if ( verb ) {
         ...
         for ( int fji=0; fji < JetsAK8->size(); fji++ ) {
            ...
            printf("  %3d :  Pt = %7.1f , Eta = %6.3f, Phi = %6.3f, pruned mass = %6.1f",
              fji, fjlv.Pt(), fjlv.Eta(), fjlv.Phi(), JetsAK8_prunedMass->at(fji)
            ) ;
