...
#ifndef analysis_bins_filler_1lep_h
#define analysis_bins_filler_1lep_h
...
class analysis_bins_filler_1lep {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   analysis_bins_filler_1lep( const char* sample_string = "QCD_HT500to700", const char* ntuple_dir = "prod-subjets-topvars3", double lumi_times_xsec=1. );
   virtual ~analysis_bins_filler_1lep();
...
#ifdef analysis_bins_filler_1lep_cxx
analysis_bins_filler_1lep::analysis_bins_filler_1lep( const char* sample_string, const char* ntuple_dir, double lumi_times_xsec ) : fChain(0) 
{
  ...
  //     events run on in order to correctly compute the dataset weight factor.
   ...
   ds_weight = lumi_times_xsec / n_entries_pre_skim ;
   ...
   sprintf( hist_file_name, "outputfiles/analysis-bin-hists-lep-%s.root", sample_string ) ;



}

analysis_bins_filler_1lep::~analysis_bins_filler_1lep()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analysis_bins_filler_1lep::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis_bins_filler_1lep::LoadTree(Long64_t entry)
{
...
void analysis_bins_filler_1lep::Init(TTree *tree)
{
...
Bool_t analysis_bins_filler_1lep::Notify()
{
...
void analysis_bins_filler_1lep::Show(Long64_t entry)
{
...
Int_t analysis_bins_filler_1lep::Cut(Long64_t entry)
{
...
#endif // #ifdef analysis_bins_filler_1lep_cxx
