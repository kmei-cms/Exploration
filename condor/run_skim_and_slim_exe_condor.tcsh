...
xrdcp root://cmseos.fnal.gov//store/user/lpcsusyhad/StealthStop/${filelistfile} filelists_Kevin/

printf "\n\n Attempting to run skim_and_slim_exe .\n\n"
./skim_and_slim_exe ${dsname} ${nfiles} ${firstfile} ${filelistfile} ${skim} ${lepton_skim} ${dilepton_skim} ${trigfile}
