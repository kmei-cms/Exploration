...
#ifndef analysis_bins_filler_h
#define analysis_bins_filler_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   analysis_bins_filler( const char* sample_string = "QCD_HT500to700", const char* ntuple_dir = "prod-subjets-topvars3", double arg_ds_weight=1. );
   virtual ~analysis_bins_filler();
...
#ifdef analysis_bins_filler_cxx
analysis_bins_filler::analysis_bins_filler( const char* sample_string, const char* ntuple_dir, double arg_ds_weight ) : fChain(0) 
{
   ...
   sprintf( hist_file_name, "outputfiles/analysis-bin-hists-%s.root", sample_string ) ;


}

analysis_bins_filler::~analysis_bins_filler()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analysis_bins_filler::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis_bins_filler::LoadTree(Long64_t entry)
{
...
void analysis_bins_filler::Init(TTree *tree)
{
...
Bool_t analysis_bins_filler::Notify()
{
...
void analysis_bins_filler::Show(Long64_t entry)
{
...
Int_t analysis_bins_filler::Cut(Long64_t entry)
{
...
#endif // #ifdef analysis_bins_filler_cxx
